...
# The shared Delta-grammar / row-shape validators live in a pure module
# ALONGSIDE this script. When the script is invoked by bare path (the test
# harness runs it as a subprocess), ensure its own directory is importable.
